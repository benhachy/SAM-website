...
for i in range(10):
    model = keras.models.load_model(
        dir_path + 'Modeles_et_fichiers_intermediaires/cnn_nouvelle_variable_50_' + str(
...
def tokenize_text(text):
                ...
                open_file = open(dir_path + "Modeles_et_fichiers_intermediaires/vocabulary_light", "rb")
...
def light_model(file):
    ...
    # read_file returns a list of technical parts and their number
    ...
    for text in texts_list[0]:
        ...
        # Contains the results if the document has more than one technical part
