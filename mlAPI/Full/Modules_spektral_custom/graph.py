...
class Graph:
    ...
    **Arguments**
    ...
    def __init__(self, x=None, a=None, e=None, y=None, f=None, **kwargs):
        if x is not None:
    ...
    def numpy(self):
        return tuple(ret for ret in [self.x, self.a, self.e, self.y, self.f] if ret is not None)
    ...
    def __repr__(self):
        return "Graph(n_nodes={}, n_node_features={}, n_edge_features={}, n_labels={}, n_graph_features={})".format(
            self.n_nodes, self.n_node_features, self.n_edge_features, self.n_labels, self.n_graph_features
        )
